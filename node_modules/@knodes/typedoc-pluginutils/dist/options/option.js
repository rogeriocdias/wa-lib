...
class Option {
    ...
    constructor(plugin, group, declaration, ...[mapper]) {
        ...
        this._declaration = Object.assign(Object.assign({}, (0, lodash_1.omit)(declaration, 'mapper')), { name: this.fullName, help: `[${this.plugin.package.name}]: ${declaration.help}` });
     ...
     */
    getValue() {
        const rawValue = this.plugin.application.options.getValue(this.fullName);
