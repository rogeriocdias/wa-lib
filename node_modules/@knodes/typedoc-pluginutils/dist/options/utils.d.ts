...
import { DeclarationOption, DeclarationOptionBase, FlagsDeclarationOption, MapDeclarationOption, ParameterType, ParameterTypeToOptionTypeMap } from 'typedoc';
...
export type ParameterValueType<T extends DeclarationOptionConfig> = NonNullable<T['type']> extends keyof TypeMap<T> ? TypeMap<T>[NonNullable<T['type']>] : TypeErr<['Unknown type', T['type']]>;
export {};
